...
# loose helpers
install_file "$SCRIPT_DIR/claude/ccusage-compact.py"      "$CLAUDE_DIR/ccusage-compact.py"
install_file "$SCRIPT_DIR/claude/ccusage-compact.sh"      "$CLAUDE_DIR/ccusage-compact.sh"
...
echo "  - confluence-update.py: set CONFLUENCE_BASE_URL and CONFLUENCE_USER env vars before running"
