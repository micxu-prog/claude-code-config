...
TOKEN_PATH = Path(os.environ.get("CONFLUENCE_TOKEN_PATH", str(Path.home() / ".config" / "confluence-update" / "token")))
BASE_URL = os.environ.get("CONFLUENCE_BASE_URL", "https://your-org.atlassian.net/wiki")
USER = os.environ.get("CONFLUENCE_USER", "your.email@example.com")
