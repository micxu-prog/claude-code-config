---
description: "Edit Microsoft Loop documents in the browser using Playwright automation. Use when the user wants to create, edit, or update a Microsoft Loop document, mentions 'Loop document', 'Loop page', or 'Loop workspace', or wants to add content to a shared document in Microsoft Loop. (Note: this is Microsoft Loop document editing, NOT the recurring-interval /loop skill.)"
---
...
> Note: this command was named `loop` in Copilot. It is renamed `copilot-loop` in Claude Code to avoid colliding with the built-in `/loop` recurring-task skill. This skill is about editing Microsoft Loop documents.

## When to Use

- User wants to create, edit, or update a Microsoft Loop document
- User mentions "Loop document", "Loop page", or "Loop workspace"
- User wants to add content to a shared document in Microsoft Loop
